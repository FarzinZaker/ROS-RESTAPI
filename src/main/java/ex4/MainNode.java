...
public class MainNode extends AbstractNodeMain {
    ...
    Subscriber<Int32> prmInfo;
    Subscriber<Float32MultiArray> cameraRectSubscriber;
...
//                }
        ...
        prmInfo = connectedNode.newSubscriber("goalInfo", Int32._TYPE);
...
//                            System.exit(0);
        ...
        // empty (length 0)
        cameraRectSubscriber = connectedNode.newSubscriber("face_rects", Float32MultiArray._TYPE);
